...
def infer(args, multiple=False):
    ...
    with open(args.classifierModel, 'rb') as f:
        ...
        reps = getsreps(args.img, args.faces)
        if len(reps) > 1:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default="{}openface/models/dlib/shape_predictor_68_face_landmarks.dat".format(main_dir))
    parser.add_argument(
        '--networkModel',
        type=str,
    ...
    inferParser.add_argument('img', type=numpy.ndarray, help="Input image.")
    inferParser.add_argument('faces', help="the position of faces in the image")
